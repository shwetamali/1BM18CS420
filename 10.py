...
def var_states():
   ...
   tk.Label(root1, text="Total Cost : "+str(cost),justify = tk.CENTER,padx = 20).pack()
...
tk.Checkbutton(root,text="PAVBHAJI", padx = 20,  variable=pavbhaji).place(relx = 0.1, rely = 0.47)
